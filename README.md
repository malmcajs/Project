...
You can also copy relaxation times T1, T2 and hetNOE from https://bmrb.io/ and run `create_exp_file.py` to automatically create the file. OBS! Copy only the data, skipping the initial text.
